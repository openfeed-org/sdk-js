...
import { ExchangeResponse_Exchange, InstrumentReferenceRequest, InstrumentReferenceResponse, InstrumentRequest, InstrumentResponse, SubscriptionType } from "@gen/openfeed_api";
import { OptionalUndefined } from "@src/utilities/messages";
export declare type OpenFeedInstrumentRequest = Omit<OptionalUndefined<InstrumentRequest>, "correlationId" | "token">;
export declare type OpenFeedInstrumentReferenceRequest = Omit<OptionalUndefined<InstrumentReferenceRequest>, "correlationId" | "token">;
